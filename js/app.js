(() => {
  ...
  (() => {
    ...
    const d = h || u || Function("return this")();
    const p = function () {
      return d.Date.now();
    };
    var f = /\s/;
    ...
    const D = function (e, t, i) {
      ...
      function v(e) {
        var i = e - a;
        return void 0 === a || i >= t || i < 0 || (d && e - h >= o);
      }
      function g() {
        var e = p();
        if (v(e)) return b(e);
      ...
      function E() {
        ...
        if (((s = arguments), (r = this), (a = e), i)) {
          if (void 0 === n)
            return (function (e) {
              return (h = e), (n = setTimeout(g, t)), u ? m(e) : l;
            })(a);
          if (d) return clearTimeout(n), (n = setTimeout(g, t)), m(a);
        }
      ...
      return (
        ...
        c(i) &&
          ((u = !!i.leading),
          (o = (d = "maxWait" in i) ? R(_(i.maxWait) || 0, t) : o),
    ...
    function P() {
      if (null === j) {
        if ("undefined" == typeof document) return (j = 0);
        var e = document.body,
    ...
    a &&
      window.addEventListener("resize", function () {
        B !== window.devicePixelRatio &&
          ((B = window.devicePixelRatio), (j = null));
      });
    var Y = function (e) {
      ...
      ie = (function () {
        function e(t, i) {
          ...
          if (
            ...
            (this.el = t),
            (this.options = H(H({}, e.defaultOptions), i)),
            (this.classNames = H(
              H({}, e.defaultOptions.classNames),
              i.classNames,
            )),
            (this.axis = {
              x: {
                ...
                f = function () {
                  l.contentWrapperEl &&
                    (-1 === d
                      ? u > p &&
                        ((u -= 40),
                        (l.contentWrapperEl[l.axis[t].scrollOffsetAttr] = u),
